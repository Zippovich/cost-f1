  ...
  $.widget("jb.dragtable", {
		...
		options: {
			...
			boundary: 'dragtable-drag-boundary',
                        disabledLeftColumns: 0,
                        disabledRightColumns: 0
		...
		_swapCol: function( to ){
			...
			if(to == this.startIndex){
				return false;
                        ...
                        if (to < this.options.disabledLeftColumns) {
                            return false;
                        }
                        
                        var colCount = this.element[0].getElementsByTagName('thead')[0].getElementsByTagName('tr')[0].getElementsByTagName('th').length - 1;
                        
                        if (to > colCount - this.options.disabledLeftColumns) {
                            return false;
                        }
